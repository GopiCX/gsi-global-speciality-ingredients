...
class BakeStableTopFilling extends React.Component {
    render() {
        return (
            <React.Fragment>
                            ...
                            <Row gutter={[20, 20]}>
                                <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 8 }} className="border-right">
                                    <div className="details">
                                        ...
                                        <ul>
                                            <li>GLORICH BSF 1997 E(Emulsifier)</li>
                                            <li>GLORICH BSF 1997 OS(Oil System)</li>
                                        </ul>
                                    </div>
                                </Col>
                                <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 8 }} className="border-right">
...
export default withRouter(BakeStableTopFilling)