...
class LiquidShortening extends React.Component {
    constructor() {
        super();
        this.state = {
            showMoreinfo: false
            ...
            <React.Fragment>
                <div className="solutions-grids  less-content  card mb-3">
                    <Row align="center">
                        ...
                        <SliderBox solutionImages={solutionImg.LiquidShortening} />
                        </Col>
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 18 }} lg={{ span: 18 }} className="p-3 p-sm-4 p-md-4 p-lg-4 " >
                            <h3 className="text-blue">Liquid Shortening</h3>
...
export default withRouter(LiquidShortening)