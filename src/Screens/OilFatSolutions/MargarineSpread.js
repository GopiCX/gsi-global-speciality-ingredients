...
class MargarineSpread extends React.Component {
    constructor() {
        super();
        this.state = {
            showMoreinfo: false
                ...
                <div className="solutions-grids  less-content  card mb-3">
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <SliderBox solutionImages={solutionImg.MargarineSpread} />
                        </Col>
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 18 }} lg={{ span: 18 }} className="p-3 p-sm-4 p-md-4 p-lg-4 " >
                            <h3 className="text-blue">Margarine Spread</h3>
                                ...
                                <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 8 }} lg={{ span: 8 }} className="border-right">
                                    <div className="details">
                                        ...
                                        <ul>
                                            ...
                                            <li>Low fat/ light spreads</li>
                                            <li>Industrial margarines</li>
                                        </ul>
                                    </div>
                                </Col>
                                <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 8 }} lg={{ span: 8 }}>
                                    <div className="details">
                                        ...
                                        <ul>
                                            ...
                                            <li>Formation of a stable crystalline structure</li>
                                            <li>Texture control</li>
                                            <li>Easier to overwork the fat products</li>
                                            <li>Optimized flavour release</li>
                                            <li>Fat melt at approx mouth temperature 35℃</li>
                                        </ul>
                                    </div>
                                </Col>
                            </Row>
...
export default withRouter(MargarineSpread)