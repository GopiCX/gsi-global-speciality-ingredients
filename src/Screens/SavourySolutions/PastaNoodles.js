...
import slide1 from '../../assets/images/savoury-solutions/pasta-noodles/1.jpg';
import slide2 from '../../assets/images/savoury-solutions/pasta-noodles/2.jpg';
import slide3 from '../../assets/images/savoury-solutions/pasta-noodles/3.jpg';
...
class PastaNoodles extends React.Component {
    render() {
        return (
            <React.Fragment>
                    ...
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <Slider {...bakeStableGallery} className="border-radius-left">
                                <div className="item">
                                    <img src={slide1} alt="Pasta & Noodles" />
                                </div>
                                <div className="item">
                                    <img src={slide2} alt="Pasta & Noodles" />
                                </div>
                                <div className="item">
                                    <img src={slide3} alt="Pasta & Noodles" />
                                </div>
                            </Slider>
                        </Col>
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 18 }} lg={{ span: 18 }} className="p-3 p-sm-4 p-md-4 p-lg-4 " >
                            <h3 className="text-blue">Pasta & Noodles</h3>
                            <Row gutter={[20, 20]}>
...
export default withRouter(PastaNoodles)