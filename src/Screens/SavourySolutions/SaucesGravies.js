...
import slide1 from '../../assets/images/savoury-solutions/sauces-gravies/1.jpg';
import slide2 from '../../assets/images/savoury-solutions/sauces-gravies/2.jpg';
                    ...
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <Slider {...bakeStableGallery} className="border-radius-left">
                                <div className="item">
                                    <img src={slide1} alt="Sauces & Gravies" />
                                </div>
                                <div className="item">
                                    <img src={slide2} alt="Sauces & Gravies" />
                                </div>
                            </Slider>
                        </Col>
...
export default withRouter(SaucesGravies)