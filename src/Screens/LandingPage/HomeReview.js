...
import developmentProductOld from "../../assets/images/development-of-product-and-capability-spectrum-old.png";
...
import innovationWheelOld from "../../assets/images/innovation-wheel-old.png";
...
class HomeReview extends React.Component {
    render() {
        return (
            <React.Fragment>
                {/* main slider starts */}
                ...
                <section className="development-product bg-blue  pattern-2  py-5 p-mob">
                    <div className="container mx-auto py-3">
                        <Row gutter={[30, 20]} align="middle" className="pb-3 ">
                            ...
                            <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 12 }} >
                                <Fade top>
                                    <img src={developmentProductOld} alt="your innovation our solution" />
                                </Fade>
                            </Col>
                        </Row>
                    </div>
                    ...
                    <div className="container mx-auto py-3">
                        <Row gutter={[30, 20]} align="center" className="text-white pb-md-3 pb-lg-3 ">
                            ...
                            <Col xs={{ span: 24 }} sm={{ span: 14 }} md={{ span: 14 }} lg={{ span: 14 }}>
                                <div className="wheel">
                                    <Fade top>
                                        <img src={innovationWheelOld} alt="Innovation Wheel" className="innovation-wheel-jpg" />
...
export default withRouter(HomeReview)