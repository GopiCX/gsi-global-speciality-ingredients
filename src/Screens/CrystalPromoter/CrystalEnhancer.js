...
class CrystalEnhancer extends React.Component {
    constructor() {
        super();
        this.state = {
            showMoreinfo: false
                ...
                <div className="solutions-grids card mb-3">
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <SliderBox solutionImages={solutionImg.crystalEnhancer} />
                        </Col>
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 18 }} lg={{ span: 18 }} className="p-3 p-sm-4 p-md-4 p-lg-4 " >
                            <h3 className="text-blue">Crystal Enhancer</h3>
...
export default withRouter(CrystalEnhancer)