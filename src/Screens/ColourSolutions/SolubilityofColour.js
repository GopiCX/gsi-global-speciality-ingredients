...
class SolubilityofColour extends React.Component {
    constructor() {
        super();
        this.state = {
            showMoreinfo: false
                            ...
                            <Row gutter={[20, 20]} className={this.state.showMoreinfo ? "showmoreinfo" : "showlessinfo"}>
                                ...
                                <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 8 }} lg={{ span: 8 }} className="border-right">
                                    <div className="details">
                                        ...
                                        <ul>
                                            <li>Oil soluble colour</li>
                                            <li>Water soluble colour</li>
                                        </ul>
                                    </div>
                                </Col>
...
export default withRouter(SolubilityofColour)