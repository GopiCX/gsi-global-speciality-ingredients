...
class NaturalSyntheticColour extends React.Component {
    constructor() {
        super();
        this.state = {
            showMoreinfo: false
...
export default withRouter(NaturalSyntheticColour)