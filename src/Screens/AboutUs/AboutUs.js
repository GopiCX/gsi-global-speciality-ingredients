                ...
                <Bounce cascade>
                  <div className="card">
                    <Row gutter={[30, 20]} className="mb-3">
                      <Col xs={{ span: 16, order: 2 }} sm={{ span: 12, order: 2 }} md={{ span: 12, order: 1 }} lg={{ span: 12, order: 1 }} >
                      ...
                      <Col xs={{ span: 8, order: 1 }} sm={{ span: 12, order: 1 }} md={{ span: 12, order: 2 }} lg={{ span: 12, order: 2 }} >
