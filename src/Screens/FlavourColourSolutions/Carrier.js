...
import slide1 from '../../assets/images/flavour-colour-solutions/carrier/1.webp';
import slide2 from '../../assets/images/flavour-colour-solutions/carrier/2.webp';
import slide3 from '../../assets/images/flavour-colour-solutions/carrier/3.webp';
                    ...
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <Slider {...bakeStableGallery} className="border-radius-left">
                                <div className="item">
                                    <img src={slide1} alt="Carrier" />
                                </div>
                                <div className="item">
                                    <img src={slide2} alt="Carrier" />
                                </div>
                                <div className="item">
                                    <img src={slide3} alt="Carrier" />
                                </div>
                            </Slider>
                        </Col>
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 18 }} lg={{ span: 18 }} className="p-3 p-sm-4 p-md-4 p-lg-4 " >
                            <h3 className="text-blue">Carrier</h3>
                            <Row gutter={[20, 20]}>
                                ...
                                <Col xs={{ span: 24 }} sm={{ span: 12 }} md={{ span: 12 }} lg={{ span: 8 }} className="border-right">
                                    <div className="details">
                                        ...
                                        <ul>
                                            <li>Oil soluble flavours</li>
                                            <li>Oil soluble colours</li>
                                        </ul>
                                    </div>
                                </Col>
