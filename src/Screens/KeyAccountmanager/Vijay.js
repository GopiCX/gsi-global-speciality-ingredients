...
import VijayQrCode from "../../assets/images/key-account-manager/Mr-Vijay.png";
        ...
        <div className="key-account-manager globe-bg card p-3 p-sm-4 p-md-4 p-lg-4 mb-3">
          <Row gutter={[20, 20]} align="center">
            ...
            >
              <img
                src={VijayQrCode}
                alt="Vijay QR code to scan"
                className="w-100 qr-contact"
              />
            </Col>
            <Col
              xs={{ span: 24 }}
              ...
              <Row gutter={[20, 20]} className="mb-4">
                ...
                >
                  ...
                  <div className="supported-region">
                    <ul>
                      <li>
                        <img src={malaysia} alt="North Malaysia" />
                        North Malaysia
                      </li>
                      <li>
                        <img src={malaysia} alt="Central Malaysia" />
                        Central Malaysia
                      </li>
                      <li>
                        <img src={malaysia} alt="East Malaysia" />
                        East Malaysia
                      </li>
                      <li>
