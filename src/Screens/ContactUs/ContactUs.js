    ...
    render() {
        return (
            <React.Fragment>
                ...
                <section className="get-in-touch pattern-1 py-5">
                    <div className="container mx-auto">
                        ...
                        <Row gutter={[30, 20]} align="center" className="pb-3 ">
                            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 20 }} lg={{ span: 17 }} className="center-contents" >
                            <div className="title-section text-center mb-4">
                               <ContactForm />
                           </div>
                            </Col>
                ...
                <section className="gsi-location bg-blue">
                    <div className="container-fluid mx-auto">
                        <Row align="center">
                            ...
                            <div className="address p-3 p-lg-5">
