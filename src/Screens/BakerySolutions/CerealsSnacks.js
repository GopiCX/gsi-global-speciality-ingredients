...
import slide1 from '../../assets/images/bakery-solutions/cereals-snacks/1.jpg';
import slide2 from '../../assets/images/bakery-solutions/cereals-snacks/2.jpg';
import slide3 from '../../assets/images/bakery-solutions/cereals-snacks/3.jpg';
                    ...
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <Slider {...bakeStableGallery} className="border-radius-left">
                                <div className="item">
                                    <img src={slide1} alt="Cereals Snacks" />
                                </div>
                                <div className="item">
                                    <img src={slide2} alt="Cereals Snacks" />
                                </div>
                                <div className="item">
                                    <img src={slide3} alt="Cereals Snacks" />
                                </div>
                            </Slider>
                        </Col>
