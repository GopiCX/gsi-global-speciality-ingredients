...
import slide1 from '../../assets/images/dairy-dairy-analogue/ice-cream-frozen-desserts/1.jpg';
import slide2 from '../../assets/images/dairy-dairy-analogue/ice-cream-frozen-desserts/2.jpg';
                    ...
                    <Row align="center">
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 6 }} lg={{ span: 6 }} >
                            <Slider {...bakeStableGallery} className="border-radius-left">
                                <div className="item">
                                    <img src={slide1} alt="Ice Cream Frozen Desserts" />
                                </div>
                                <div className="item">
                                    <img src={slide2} alt="Ice Cream Frozen Desserts" />
                                </div>
                            </Slider>
                        </Col>
